...
peru_cases_line <- peru_tidy %>% 
  ...
  labs(title = "The trend of total cases in Peru from 2020 to 2021",
       x = "",
       y = "") +
  annotate("text",
...
peru_deaths_line <- peru_tidy %>% 
  ...
  scale_x_date(breaks = "3 months") +
  scale_y_continuous(labels = scales::comma) + 
  labs(title = "The trend of total deaths in Peru from 2020 to 2021",
       x = "",
       y = "") +
  annotate("text",
           x = as.Date("2021-06-30"),
...
peru_new <- covid_peru %>% 
 ...
 # geom_line(data = peru_newde_week, 
  ...
  theme_bw()+
  labs(title = "The trend of daily new deaths in Peru from 2020 to 2021",
       x = "Date",
       y = "New Death Number")+
...
age_fig <- age_tidy %>% 
 ...
 # mutate(crop_oil = fct_relevel(crop_oil, "Palm", "Soybean", "Rapeseed", "Sunflower", "Other")) %>%
  ...
  #scale_y_continuous()+
  labs(title = "Vaccination percentage by age in Peru in 2021",
       subtitle = "",
       x = "Date",
